...
for (k in 1:nlam){  
  ...
  Iee[[k]] <- mod.false[[k]]$IM[16:19,16:19]#/mod.false[[k]]$m
  Ibb[[k]] <- mod.false[[k]]$IM[1:15,1:15]#/mod.false[[k]]$m
  Ibe[[k]] <- mod.false[[k]]$IM[1:15,16:19]#/mod.false[[k]]$m
  Ieb[[k]] <- t(Ibe[[k]])
  ...
  ######################### Histograms ###############################
 load(file="sim_n1000_ncat3_ncov2dic.RData")
 
 pdf(file="sim_n1000_ncat3_ncov2dic.pdf",width=12,height=10)
 ...
 dev.off()
# save.image(file="sim_n1000_ncat3_ncov2dic.RData")
