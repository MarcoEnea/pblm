...
for (k in 1:nlam){  
  ...
  # when fo2 and fo12 are not specified, the pblm's default behaviour is 
  # to set them to be equal to fo1
 ...
 pdf(file="sim2_n500_ncat3_ncov2dic_chisq3df.pdf",width=12,height=10)
 ...
 for (k in 1:nlam){
   ...
   lines(seq(0,25,l=500),dchisq(seq(0,25,l=500),3),col=2,lty=2)   
...
#save.image(file="sim2_n500_ncat3_ncov2dic.RData")
