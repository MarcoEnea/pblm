...
corresponding pblm functions pb() and pbs() are based on. They also helped the first author with their useful suggestions on the implementation of the backfitting 
...
contains three R codes, according to the sample size (200, 500, and 1000), for the simulationscheme 1 when D_1=D_2=3. The execution of file "sim_n200_ncat3_ncov2dic.R" 
...
run and their workspaces saved, the code "Figure_sim1.R" can be executed to produce a figure (sim1_ncat3_ncov2dic_all.pdf) which compares the three scenarios for some lamba values.
