...
library(xtable)
xtable(be,digits=2)
sim_m1000_n1000<-list(param=param,lambda=lambda,ris0=ris0,
                      ris1=ris1,a1=a1,seed=1234,be=be)
save(sim_m1000_n1000,file="sim_m1000_n1000_NEW.RData")


ris1 <- sim_m1000_n1000$ris1
param <- sim_m1000_n1000$param
a1 <- sim_m1000_n1000$a1
ris0 <- sim_m1000_n1000$ris0
be <- sim_m1000_n1000$be
